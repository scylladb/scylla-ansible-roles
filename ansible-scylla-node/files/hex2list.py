...
#Original of below is in Scylla repo, this is just for ansible purposes
# https://github.com/scylladb/scylla/blob/master/dist/common/scripts/scylla_util.py#L568
